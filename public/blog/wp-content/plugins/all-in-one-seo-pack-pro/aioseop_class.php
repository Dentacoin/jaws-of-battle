...
class All_in_One_SEO_Pack extends All_in_One_SEO_Pack_Module {
	...
	function All_in_One_SEO_Pack() {
		...
		$this->help_text = Array(
			"license_key"			=> __( "This will be the license key received when the product was purchased. This is used for automatic upgrades.", 'all_in_one_seo_pack'),
			...
			"taxactive" 			=> __( "Use these checkboxes to select which Taxonomies you want to use All in One SEO Pack with.", 'all_in_one_seo_pack' ),
		...
		$this->default_options = array( 
		   "license_key" => Array( 
			       'name' => __( 'License Key:', 'all_in_one_seo_pack' ), 
			       'type' => 'text' ),
		   "home_title"=> Array( 
		   ...
		   "404_title_format"=> Array( 
			...
			"taxactive" => Array(
				'name' => __( 'SEO on only these taxonomies:', 'all_in_one_seo_pack' ), 
				    ...
				    'aiosp' => Array( 'name' => $this->plugin_name, 'type' => 'metabox', 'prefix' => '', 'help_link' => 'http://semperplugins.com/sections/postpage-settings/',
																	...
																	'default_options' => Array( 
																		...
																		'upgrade' 			 => Array( 'type' => 'html', 'label' => 'none',
																										...
																										. __( 'Support Forum', 'all_in_one_seo_pack' ) . '</a>'
																					 		),
			...
			$this->layout = Array(
				...
				'cpt' => Array(
						...
						'options' => Array( "enablecpost", "cpostactive", "taxactive", "cpostadvanced", "cposttitles" )
					),
				'display' => Array(
	...
	function add_page_hooks() {
		...
		foreach ( $tax_types as $p => $pt ) {
			...
			if ( !isset( $this->default_options[$field] ) ) {
				$this->default_options[$field] = Array (
						'name' => "$name " . __( 'Taxonomy Title Format:', 'all_in_one_seo_pack' ),						
						'type' => 'text',
				...
				$this->help_text[$field] = __( "The following macros are supported:", 'all_in_one_seo_pack' ) .
					'<ul><li>' . __( '%blog_title% - Your blog title', 'all_in_one_seo_pack' ) . '</li><li>' . 
					__( '%blog_description% - Your blog description', 'all_in_one_seo_pack' ) . '</li><li>' . 
					__( '%taxonomy_title% - The original title of the taxonomy', 'all_in_one_seo_pack' ) . '</li><li>' . 
					__( '%taxonomy_description% - The description of the taxonomy', 'all_in_one_seo_pack' ) . '</li></ul>';
				$this->help_anchors[$field] = '#custom-titles';				
				$this->layout['cpt']['options'][] = $field;
			}
		}
	...
	function add_admin_pointers() {
		$this->pointers['aioseop_menu_236'] = Array( 'pointer_target' => '#toplevel_page_all-in-one-seo-pack-pro-aioseop_class',
												 'pointer_text' => 	'<h3>' . sprintf( __( 'Welcome to Version %s!', 'all_in_one_seo_pack' ), AIOSEOP_VERSION )
													. '</h3><p>' . __( 'Thank you for running the latest and greatest All in One SEO Pack Pro ever! Please review your settings, as we\'re always adding new features for you!', 'all_in_one_seo_pack' ) . '</p>',
												 'pointer_edge' => 'top',
												 'pointer_align' => 'left',
		...
		$this->pointers['aioseop_welcome_230'] = Array( 'pointer_target' => '#aioseop_top_button',
													...
													. '</h3><p>' . __( 'New in 2.3: improved support for taxonomies and a Video Sitemap module; enable modules from our feature manager! And please review your settings, we have added some new ones!', 'all_in_one_seo_pack' ) . '</p>',
													 'pointer_edge' => 'bottom',
													 'pointer_align' => 'left',
													 'pointer_scope' => 'local'
											 );
	...
	/**
	 * Handle resetting options to defaults, but preserve the license key.
	 */
	...
	function display_extra_metaboxes( $add, $meta ) {
		...
		switch ( $meta['id'] ) {
		    ...
		    case "aioseop-support":
				...
				href="http://semperplugins.com/documentation/all-in-one-seo-pack-pro-changelog/"><?php _e( 'View the Changelog', 'all_in_one_seo_pack' ); ?></a></p>
...
// Thank you, Yoast de Valk, for much of this code.	
	...
	function admin_menu() {		
		...
		add_meta_box('aioseop-about', __( "About", 'all_in_one_seo_pack' ), array( $this, 'display_extra_metaboxes'), 'aioseop_metaboxes', 'side', 'core');
