...
if (!empty($category)) {
    ...
    <main class="page-homepage">
        ...
        <section class="posts-list-section container">
            ...
            <?php echo do_shortcode('[post_categories_list class="padding-top-30 padding-bottom-30 padding-top-xs-10 padding-bottom-xs-10 text-center" type="'.$category->slug.'"]'); ?>
