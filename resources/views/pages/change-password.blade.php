...
@section("content")
    <section class="change-password-section">
        ...
        <div class="form-container color-white padding-top-50 padding-bottom-50 max-width-600 margin-0-auto padding-left-15 padding-right-15">
            <form class="change-password-form" action="{{ route('submit-change-password') }}">
                <h1 class="text-center fs-44 lato-black">PASSWORD RECOVER</h1>
                <div class="text-center fs-26 padding-bottom-25">Please enter your new password.</div>
