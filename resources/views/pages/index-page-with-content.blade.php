...
@section("content")
    ...
    {{--<section class="section-intro">
        <div class="frame-figure">
            ...
            <picture itemscope="" itemtype="http://schema.org/ImageObject" class="display-block">
                <source media="(max-width: 768px)" srcset="/assets/uploads/dentacare-game-home-page-card-arch-mobile.png">
                <img alt="Frame" itemprop="contentUrl" src="/assets/uploads/dentacare-game-home-page-card-arch.png" class="width-100 frame">
            </picture>
        </div>
        <picture itemscope="" itemtype="http://schema.org/ImageObject" class="hidden-frame">
            <source media="(max-width: 768px)" srcset="/assets/uploads/dentacare-game-home-page-card-arch-mobile.png">
            <img alt="Frame" itemprop="contentUrl" src="/assets/uploads/dentacare-game-home-page-card-arch.png" class="width-100">
        </picture>
        <div class="absolute-content">
            <picture itemscope="" itemtype="http://schema.org/ImageObject" class="moving-image display-block">
                <source media="(max-width: 750px)" srcset="/assets/uploads/3000px-dentacare-website-mooving-header-sprite-.png">
                <source media="(max-width: 1500px)" srcset="/assets/uploads/6000px-dentacare-website-mooving-header-sprite-.png">
                <img alt="Jaws of battle characters" itemprop="contentUrl" src="/assets/uploads/7772px-dentacare-website-mooving-header-sprite.png">
            </picture>
        </div>
            ...
            <div class="container text-center padding-bottom-30">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        [shortcode type="card-types-slider"]
                        <div class="line-separator"></div>
                        <div>
                            <figure itemscope="" itemtype="http://schema.org/ImageObject" class="inline-block padding-left-20 padding-right-20 padding-left-xs-5 padding-right-xs-5">
                                <img src="/assets/uploads/toothx1.png" class="width-100 max-width-xs-90 max-width-200" alt="Tooth x1"/>
                            </figure>
                            <figure itemscope="" itemtype="http://schema.org/ImageObject" class="inline-block padding-left-20 padding-right-20 padding-left-xs-5 padding-right-xs-5">
                                <img src="/assets/uploads/toothx2.png" class="width-100 max-width-xs-90 max-width-200" alt="Tooth x2"/>
                            </figure>
                            <figure itemscope="" itemtype="http://schema.org/ImageObject" class="inline-block padding-left-20 padding-right-20 padding-left-xs-5 padding-right-xs-5">
                                <img src="/assets/uploads/toothx3.png" class="width-100 max-width-xs-90 max-width-200" alt="Tooth x3"/>
                            </figure>
                        </div>
                    </div>
    ...
    <section class="section-a-jaw-breaking-game-experience">
        <div class="container-fluid padding-bottom-50">
            <div class="row fs-0">
                ...
                <div class="inline-block-top color-white col-xs-12 col-sm-10 col-sm-offset-1 col-lg-4 col-lg-offset-0 padding-top-sm-50 padding-top-md-50 padding-top-250 padding-top-xs-70 fs-18 line-height-20">
                    <h2 class="fs-40 fs-xs-24 line-height-55 line-height-xs-34 lato-black">A JAW-BREAKING CARD GAME EXPERIENCE</h2><br>
                    <p>
        ...
        <div class="container padding-bottom-50">
            <div class="row">
                <div class="col-xs-12">
                    [shortcode type="featured-cards-slider"]
                </div>
            </div>
        </div>
    </section>--}}
